...
def escrever(request):
    if request.method == "GET":
        ...
        for i in pessoas:
            print(i.nome)
        return render(request, "escrever.html", {"pessoas": pessoas}) #com as chaves estou abrindo um dicionario
        ...
        if len(titulo.strip()) == 0 or len (texto.strip()) == 0:
            #fazer: Adicionar mensagens de erro
        ...
        #fazer: Adicionar mensagens de sucesso
        return redirect("escrever")
